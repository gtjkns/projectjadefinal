...
--
-- Host: localhost
-- Generation Time: Apr 30, 2016 at 05:57 PM
...
--
-- Table structure for table `doc_disease_count`
--

CREATE TABLE IF NOT EXISTS `doc_disease_count` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `doc_id` int(11) NOT NULL,
  `num_patient` int(11) NOT NULL,
  `num_med` int(11) NOT NULL,
  `num_atnd_h` int(11) NOT NULL,
  `date_time` datetime NOT NULL,
  `d_id` int(11) NOT NULL,
  `if_foreign` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `doc_disease_count`
--
...
--
-- Table structure for table `pat_feedback_d`
--

CREATE TABLE IF NOT EXISTS `pat_feedback_d` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pat_feedback_d`
--
...
--
-- Table structure for table `pat_feedback_s`
--

CREATE TABLE IF NOT EXISTS `pat_feedback_s` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `p_id` int(11) NOT NULL,
...
--
-- Dumping data for table `pat_feedback_s`
--

INSERT INTO `pat_feedback_s` (`id`, `p_id`, `s_id`, `feedback`, `date_time`) VALUES
(1, 1, 46, 'jhvhgv hgvh hgvh hghg ', '2016-04-30 18:37:07');

-- --------------------------------------------------------

--
-- Table structure for table `pdhp_city`
--

CREATE TABLE IF NOT EXISTS `pdhp_city` (
...
--
-- Dumping data for table `pdhp_city`
--

INSERT INTO `pdhp_city` (`id`, `region_id`, `name`, `timezone`) VALUES
...
--
-- Table structure for table `pdhp_country`
--

CREATE TABLE IF NOT EXISTS `pdhp_country` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_country`
--

INSERT INTO `pdhp_country` (`id`, `iso`, `iso3`, `fips`, `country`, `continent`, `currency_code`, `currency_name`, `phone_prefix`, `postal_code`, `languages`, `geonameid`) VALUES
...
--
-- Table structure for table `pdhp_dept`
--

CREATE TABLE IF NOT EXISTS `pdhp_dept` (
...
--
-- Dumping data for table `pdhp_dept`
--

INSERT INTO `pdhp_dept` (`id`, `dept_name`) VALUES
(1, 'ICU'),
(2, 'NICU'),
...
(11, 'Gastroenterology'),
(12, 'Haematology'),
(13, 'MaMicrobiologyternity department'),
(14, 'Nephrology'),
(15, 'Neurology'),
(16, 'Nutrition and dietetics'),
(17, 'Obstetrics and gynaecology units'),
...
(25, 'Renal unit'),
(26, 'Rheumatology'),
(27, 'Sexual health (genitourinary medicine)'),
(28, 'Urology');

-- --------------------------------------------------------

--
-- Table structure for table `pdhp_dept_seat`
--

CREATE TABLE IF NOT EXISTS `pdhp_dept_seat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_dept_seat`
--
...
--
-- Table structure for table `pdhp_disease`
--

CREATE TABLE IF NOT EXISTS `pdhp_disease` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_disease`
--

INSERT INTO `pdhp_disease` (`id`, `disease`, `description`) VALUES
(1, 'Abdominal Aortic Aneurysm', ''),
(2, 'Acanthamoeba Infection', ''),
(3, 'Acinetobacter Infection', ''),
(4, 'Acquired Immune Deficiency Syndrome (AIDS)', ''),
(5, 'Adenovirus Infection', ''),
(6, 'Adenovirus Vaccination', ''),
(7, 'Adult Vaccinations', ''),
(8, 'African Trypanosomiasis( Sleeping Sickness)', ''),
(9, 'AHF (Alkhurma hemorrhagic fever)', ''),
(10, 'Alkhurma hemorrhagic fever (AHF)', ''),
(11, 'ALS [Amyotrophic Lateral Sclerosis]', ''),
(12, 'Alzheimers Disease', ''),
(13, 'Amebiasis, Intestinal [Entamoeba histolytica infection]', ''),
(14, 'American Trypanosomiasis', ''),
(15, 'Amyotrophic Lateral Sclerosis ( ALS)', ''),
(16, 'Anaplasmosis, Human', ''),
(17, 'Ancylostoma duodenale Infection', ''),
(18, 'Necator americanus Infection( Human Hookworm)', ''),
(19, 'Angiostrongylus Infection', ''),
(20, 'Anisakiasis', ''),
(21, 'Anthrax [Bacillus anthracis Infection]', ''),
(22, 'Aortic Aneurysm', ''),
(23, 'Aortic Dissection', ''),
(24, 'Arenavirus Infection', ''),
(25, 'Arthritis', ''),
(26, 'Fibromyalgia', ''),
(27, 'Gout', ''),
(28, 'Osteoarthritis (OA)', ''),
(29, 'Rheumatoid Arthritis (RA)', ''),
(30, 'Aseptic Meningitis', ''),
(31, 'Aspergillosis', ''),
(32, 'Aspergillus Infection', ''),
(33, 'Asthma', ''),
(34, 'Attention Deficit/Hyperactivity Disorder', ''),
(35, 'Autism', ''),
(36, 'B virus Infection [Herpes B virus]', ''),
(37, 'B. cepacia infection (Burkholderia cepacia Infection)', ''),
(38, 'Babesia Infection', ''),
(39, 'Babesiosis', ''),
(40, 'Back Belts', ''),
(41, 'Bacterial Meningitis', ''),
(42, 'Bacterial Vaginosis (BV)', ''),
(43, 'Balamuthia mandrillaris Infection', ''),
(44, 'Balamuthia Infection', ''),
(45, 'Balantidiasis', ''),
(46, 'Balantidium Infection [Balantidiasis]', ''),
(47, 'Bartonella bacilliformis Infection', ''),
(48, 'Bartonella quintana Infection', ''),
(49, 'Baylisascaris Infection', ''),
(50, 'BCG (Tuberculosis Vaccine)', ''),
(51, 'Bilharzia', ''),
(52, 'Bioterrorism Agents/Diseases', ''),
(53, 'Bird Flu ', ''),
(54, 'Birth Defects', ''),
(55, 'Black Lung [Coal Workers Pneumoconioses]', ''),
(56, 'Blast Injuries', ''),
(57, 'Blastocystis hominis Infection', ''),
(58, 'Blastocystis Infection [Blastocystis hominis Infection]', ''),
(59, 'Bleeding Disorders', ''),
(60, 'blood clot', ''),
(61, 'Blood Disorders', ''),
(62, 'Body Lice [Pediculus humanus corporis]', ''),
(63, 'Borrelia burgdorferi Infection', ''),
(64, 'Botulism [Clostridium botulinim Infection]', ''),
(65, 'Bovine Spongiform Encephalopathy (BSE)', ''),
(66, 'Brainerd Diarrhea', ''),
(67, 'Breast and Ovarian Cancer and Family Health History', ''),
(68, 'National Breast and Cervical Cancer Early Detection Program (NBCCEDP)', ''),
(69, 'Breastfeeding', ''),
(70, 'Bronchiolitis', ''),
(71, 'Bronchitis', ''),
(72, 'Brucella Infection [Brucellosis]', ''),
(73, 'Brucellosis', ''),
(74, 'BSE (Bovine Spongiform Encephalopathy)', ''),
(75, 'Burkholderia cepacia Infection (B. cepacia infection)', ''),
(76, 'Burkholderia mallei', ''),
(77, 'Burkholderia pseudomallei Infection', ''),
(78, 'BV (Bacterial Vaginosis)', ''),
(79, 'Colorectal (Colon) Cancer', ''),
(80, 'C. neoformans cryptococcosis', ''),
(81, 'Gynecologic Cancers', ''),
(82, 'Lung Cancer', ''),
(83, 'Prostate Cancer', ''),
(84, 'Candida Infection [Candidiasis]', ''),
(85, 'Genital Candidiasis (VVC) [Vulvovaginal Candidiasis]', ''),
(86, 'Invasive Candidiasis', ''),
(87, 'Thrush [Oropharyngeal Candidiasis]', ''),
(88, 'Candidiasis', ''),
(89, 'Canine Flu', ''),
(90, 'Capillaria Infection [Capillariasis]', ''),
(91, 'Capillariasis â€” see Capillaria Infection', ''),
(92, 'Carbapenem resistant Klebsiella pneumonia (CRKP) â€” see Klebsiella pneumoniae', ''),
(93, 'Carbapenem-resistant nterobacteriaceae (CRE)', ''),
(94, 'Cardiovascular Health â€” see Heart Disease', ''),
(95, 'Carpal Tunnel Syndrome â€” see Ergonomic and Musculoskeletal Disorders', ''),
(96, 'CarriÃ³nâ€™s disease [Bartonella bacilliformis Infection]', ''),
(97, 'Cat Scratch Disease from Pets', ''),
(98, 'CCHF (Crimean-Congo hemorrhagic fever)', ''),
(99, 'Cercarial Dermatitis', ''),
(100, 'Cerebral Palsy', ''),
(101, 'Cervical Cancer', ''),
(102, 'CFS (Chronic Fatigue Syndrome)', ''),
(103, 'Chagas Disease [Trypanosoma cruzi Infection]', ''),
(104, 'Chapare Hemorrhagic Fever (CHHF)', ''),
(105, 'Chest Cold', ''),
(106, 'CHHF (Chapare Hemorrhagic Fever)', ''),
(107, 'Chickenpox [Varicella Disease]', ''),
(108, 'Chickenpox Vaccination', ''),
(109, 'Chikungunya Fever (CHIKV)', ''),
(110, 'CHIKV (Chikungunya Fever)', ''),
(111, 'Childhood Arthritis', ''),
(112, 'Childhood Injuries', ''),
(113, 'Childhood Overweight and Obesity', ''),
(114, 'Chlamydia [Chlamydia trachomatis isease]', ''),
(115, 'Chlamydophila (Chlamydia) pneumoniae Infection', ''),
(116, 'Cholera [Vibrio cholerae Infection]', ''),
(117, 'Chronic Disease Prevention', ''),
(118, 'Chronic Fatigue Syndrome (CFS)', ''),
(119, 'Chronic Kidney Disease (CKD)', ''),
(120, 'Chronic Obstructive Pulmonary Disease (COPD)', ''),
(121, 'Chronic Wasting Disease (CWD)', ''),
(122, 'Ciguatera Fish Poisoning', ''),
(123, 'Ciguatoxin', ''),
(124, 'CJD, Classic (Classic Creutzfeldt-Jakob Disease)', ''),
(125, 'CKD (Chronic Kidney Disease)', ''),
(126, 'CKD (Kidney Disease)', ''),
(127, 'Classic Creutzfeldt-Jakob Disease (CJD, Classic)', ''),
(128, 'Clonorchiasis', ''),
(129, 'Clostridium botulinim Infection', ''),
(130, 'Clostridium difficile Infection', ''),
(131, 'Clostridium perfringens infection', ''),
(132, 'Clostridium tetani Infection', ''),
(133, 'Clotting Disorders', ''),
(134, 'CMV (Cytomegalovirus Infection)', ''),
(135, 'Coal Workers'' Pneumoconioses', ''),
(136, 'Coccidioidomycosis', ''),
(137, 'Cold, Common', ''),
(138, 'Colorado Tick Fever (CTF)', ''),
(139, 'Colorectal (Colon) Cancer', ''),
(140, 'Colorectal Cancer Control Program (CRCCP)', ''),
(141, 'Colorectal Cancer and Genetics', ''),
(142, 'Congenital Hearing Loss', ''),
(143, 'Conjunctivitis ', ''),
(144, 'COPD (Chronic Obstructive Pulmonary Disease)', ''),
(145, 'Corynebacterium diphtheriae Infection', ''),
(146, 'Cough and Cold Medicines', ''),
(147, 'Coxiella burnetii Infection', ''),
(148, 'CRE (Carbapenem-resistant Enterobacteriaceae)', ''),
(149, 'Creutzfeldt-Jakob Disease, Classic ', ''),
(150, 'Crimean-Congo hemorrhagic fever (CCHF) [Nairovirus Infection]', ''),
(151, 'CRKP (Carbapenem resistant ,lebsiella pneumonia )', ''),
(152, 'Crohnâ€™s Disease', ''),
(153, 'Cronobacter Infection', ''),
(154, 'Cryptococcosis, C. gattii.', ''),
(155, 'Cryptococcosis, C. neoformans', ''),
(156, 'Cryptosporidiosis ', ''),
(157, 'Cryptosporidium Infection [Cryptosporidiosis]', ''),
(158, 'CTF (Colorado Tick Fever)', ''),
(159, 'CWD (Chronic Wasting Disease)', ''),
(160, 'Cyclospora Infection [Cyclosporiasis]', ''),
(161, 'Cyclosporiasis', ''),
(162, 'Cysticercosis', ''),
(163, 'Cystoisospora Infection [Cystoisosporiasis]', ''),
(164, 'Cystoisosporiasis', ''),
(165, 'Cytomegalovirus Infection (CMV)', ''),
(166, 'DBA (Diamond Blackfan Anemia)', ''),
(167, 'Death, Leading Causes of Death in Males', ''),
(168, 'Deep Vein Thrombosis (DVT)', ''),
(169, 'Dengue Fever (DF)', ''),
(170, 'Dengue Hemorrhagic Fever (DHF)', ''),
(171, 'Dermatophyte Infection', ''),
(172, 'Developmental Disabilities', ''),
(173, 'Diabetes', ''),
(174, 'Diamond Blackfan Anemia (DBA)', ''),
(175, 'Dientamoeba fragilis Infection', ''),
(176, 'Diphtheria [Corynebacterium diphtheriae Infection]', ''),
(177, 'Diphtheria Vaccination', ''),
(178, 'Diphyllobothriasis', ''),
(179, 'Diphyllobothrium Infection [Diphyllobothriasis]', ''),
(180, 'Dog Bites', ''),
(181, 'Dogs, Infections from', ''),
(182, 'Down Syndrome [Trisomy 21]', ''),
(183, 'Dracunculiasis', ''),
(184, 'Drug Resistance', ''),
(185, 'DVT (Deep Vein Thrombosis)', ''),
(186, 'Dwarf Tapeworm [Hymenolepis Infection]', ''),
(187, 'E. coli Infection [Escherichia coli Infection]', ''),
(188, 'Ear Infection [Otitis Media]', ''),
(189, 'Early Hearing Detection and Intervention (EHDI)Early Detection & Intervention', ''),
(190, 'Eastern Equine Encephalitis (EEE)', ''),
(191, 'Ebola Virus Disease (EVD)', ''),
(192, 'EBV Infection (Epstein-Barr Virus Infection)', ''),
(193, 'Echinococcosis', ''),
(194, 'EEE (Eastern Equine Encephalitis)', ''),
(195, 'EHDI (Early Hearing Detection and Intervention)', ''),
(196, 'Ehrlichiosis, Human', ''),
(197, 'Elephantiasis', ''),
(198, 'Emerging Infectious Diseases', ''),
(199, 'Endophthalmitis, Fungal', ''),
(200, 'Entamoeba histolytica infection', ''),
(201, 'Enteric Diseases from Animals', ''),
(202, 'Enterobius vermicularis Infection', ''),
(203, 'Enterovirus D68', ''),
(204, 'Enterovirus Infections (Non-Polio)', ''),
(205, 'Epidemic Typhus', ''),
(206, 'Epilepsy', ''),
(207, 'Epstein-Barr Virus Infection (EBV Infection)', ''),
(208, 'Ergonomic and Musculoskeletal Disorders', ''),
(209, 'Esophageal Candidiasis', ''),
(210, 'EV-D68', ''),
(211, 'EVD (Ebola Virus Disease)', ''),
(212, 'Exserohilum rostratum (Other Pathogenic Fungi)', ''),
(213, 'Extensively Drug-Resistant TB (XDR TB)', ''),
(214, 'Extreme Cold [Hypothermia]', ''),
(215, 'Extreme Heat [Hyperthermia]', ''),
(216, 'Falls from Elevation', ''),
(217, 'Falls, Older Adults', ''),
(218, 'Farm Worker Injuries', ''),
(219, 'Fasciitis, Necrotizing', ''),
(220, 'Fasciola Infection [Fascioliasis]', ''),
(221, 'Fascioliasis', ''),
(222, 'Fasciolopsiasis', ''),
(223, 'Fasciolopsis Infection [Fasciolopsiasis]', ''),
(224, 'Fetal Alcohol Spectrum Disorder', ''),
(225, 'FETP', ''),
(226, 'Fibromyalgia', ''),
(227, 'Fifth Disease [Parvovirus B19 Infection]', ''),
(228, 'Filariasis, Lymphatic', ''),
(229, 'Fireworks Injuries', ''),
(230, 'Flavorings-Related Lung Disease', ''),
(231, 'Flu', ''),
(232, 'Flu and Cancer', ''),
(233, 'Flu Vaccination', ''),
(234, 'Flu, Pandemic', ''),
...
(236, 'Folliculitis', ''),
(237, 'Food Poisoning', ''),
(238, 'Food-Related Diseases', ''),
(239, 'Foodborne Illness', ''),
(240, 'Fragile X Syndrome (FXS)', ''),
(241, 'Francisella tularensis Infection', ''),
(242, 'Fungal diseases [Mycotic diseases]', ''),
(243, 'Fungal Eye Infections', ''),
(244, 'Fungal Meningitis', ''),
(245, 'Fungal Pneumonia', ''),
(246, 'FXS (Fragile X Syndrome)', ''),
(247, 'GAE (Acanthamoe (Granulomatous Amebic Encephalitis (Acanthamoeba))', ''),
(248, 'GAE (Granulomatous amebic encephalitis)', ''),
(249, 'GAS (Group A Strep Infection)', ''),
(250, 'Gastrointestinal Diseases from Animals [Zoonotic enteric diseases]', ''),
(251, 'GBS (Group B Strep Infection)', ''),
(252, 'GBS and Menactra Meningococcal Vaccine', ''),
(253, 'GDDER (Global Disease Detection and Emergency Response)', ''),
(254, 'Genetics and Colorectal Cancer', ''),
(255, 'Genetics and Heart Disease', ''),
(256, 'Genetics and Mental Health', ''),
(257, 'Genetics and Obesity', ''),
(258, 'Genetics and Skin Cancer', ''),
(259, 'Genetics and Stroke', ''),
(260, 'Genital Candidiasis (VVC) [Vulvovaginal Candidiasis]', ''),
(261, 'Genital Herpes [Herpes Simplex Virus Infection]', ''),
(262, 'Genital Warts', ''),
(263, 'German Measles (Rubella Virus)', ''),
(264, 'Giardia Infection [Giardiasis]', ''),
(265, 'Giardiasis', ''),
(266, 'Glanders [Burkholderia mallei]', ''),
(267, 'Gnathostoma Infection', ''),
(268, 'Gnathostomiasis [Gnathostoma Infection]', ''),
(269, 'Gonorrhea [Neisseria gonorrhoeae Infection]', ''),
(270, 'Gout', ''),
(271, 'Granulomatous amebic encephalitis (GAE)', ''),
(272, 'Granulomatous Amebic Encephalitis (Acanthamoeba) (GAE (Acanthamoe)', ''),
(273, 'Guillain-BarrÃ© Syndrome and Menactra Meningococcal Vaccine', ''),
(274, 'Guinea Worm Disease [Dracunculiasis]', ''),
(275, 'Gynecologic Cancers', ''),
(276, 'H3N2v influenza', ''),
(277, 'H5N1 â€” see Avian Influenza', ''),
(278, 'Haemophilus influenzae Infection (including Hib Infection)', ''),
(279, 'Haemophilus influenzae Serotype b ', ''),
(280, 'Hand, Foot, and Mouth Disease (HFMD)', ''),
(281, 'Hansen''s Disease', ''),
(282, 'Hantavirus Pulmonary Syndrome (HPS)', ''),
(283, 'Hazardous Drug Exposures in Healthcare', ''),
(284, 'Head Lice [Pediculus humanus capitis]', ''),
(285, 'Health Disparities in Cancer', ''),
(286, 'Healthcare Associated Infections', ''),
(287, 'surgical site infection (SSI)', ''),
(288, 'Healthy Weight', ''),
(289, 'Hearing, Early Detection & Intervention', ''),
(290, 'Heart Disease [Cardiovascular Health]', ''),
(291, 'Heart Disease and Genetics', ''),
(292, 'Heat Stress', ''),
(293, 'Hemochromatosis', ''),
(294, 'Hemoglobinopathies', ''),
(295, 'Hemophilia', ''),
(296, 'Hemophilia Treatment Centers (HTC)', ''),
(297, 'Hemorrhagic Fevers, Viral', ''),
(298, 'Hendra Virus Disease (HeV Infection)', ''),
(299, 'Hepatitis A Vaccination', ''),
(300, 'Hepatitis B Vaccination', ''),
(301, 'Hepatitis, Viral', ''),
(302, 'Hereditary Bleeding Disorders', ''),
(303, 'Herpes B virus', ''),
(304, 'Herpes Simplex Virus Infection', ''),
(305, 'Herpes Zoster', ''),
(306, 'Herpes Zoster Vaccination', ''),
(307, 'Herpes, Genital', ''),
(308, 'Herpesvirus B', ''),
(309, 'Herpesvirus simiae', ''),
(310, 'Heterophyes Infection [Heterophyiasis]', ''),
(311, 'Heterophyiasis', ''),
(312, 'HeV Infection (Hendra Virus Disease)', ''),
(313, 'HFMD (Hand, Foot, and Mouth Disease)', ''),
(314, 'Hib Infection [Haemophilus influenzae Serotype b]', ''),
(315, 'Hib Vaccine (Haemophilus influenzae Serotype b Vaccination)', ''),
(316, 'High Blood Pressure', ''),
(317, 'Histoplasma capsulatum Infection [Histoplasmosis]', ''),
(318, 'Histoplasmosis', ''),
(319, 'Hookworm, Human [Ancylostoma duodenale Infection, Necator americanus Infection]', ''),
(320, 'Hookworm, Zoonotic', ''),
(321, 'Hot Tub Rash [Pseudomonas dermatitis Infection]', ''),
(322, 'HPIV (Human Parainfluenza Viruses)', ''),
(323, 'HPS (Hantavirus Pulmonary Syndrome)', ''),
(324, 'HPV Infection (Human Papillomavirus Infection)', ''),
(325, 'HPV Vaccination (Human Papillomavirus Vaccination)', ''),
(326, 'HPV-Associated Cancers', ''),
(327, 'HTC (Hemophilia Treatment Centers)', ''),
(328, 'Human Ehrlichiosis', ''),
(329, 'Human Hookworm [Ancylostoma duodenale Infection, Necator americanus Infection]', ''),
(330, 'Human Papillomavirus Infection (HPV Infection)', ''),
(331, 'Human Papillomavirus Vaccination (HPV Vaccination)', ''),
(332, 'Human Parainfluenza Viruses (HPIV)', ''),
(333, 'Hymenolepis Infection â€” see Dwarf Tapeworm', ''),
(334, 'Hypertension', ''),
(335, 'Hyperthermia', ''),
(336, 'Hypothermia', ''),
(337, 'IBD (Inflammatory Bowel Disease)', ''),
(338, 'IMMPaCt (International Micronutrient Malnutrition Prevention and Control Program)', ''),
(339, 'Impetigo', ''),
(340, 'including Hib Infection (Haemophilus influenzae Infection)', ''),
(341, 'Infectious Mononucleosis', ''),
(342, 'Infertility', ''),
(343, 'Inflammatory Bowel Disease (IBD)', ''),
(344, 'Influenza', ''),
(345, 'Injury, Healthy Swimming and Recreational Water', ''),
(346, 'Iron Overload [Hemochromatosis]', ''),
(347, 'Iron Storage Disease', ''),
(348, 'Isospora Infection [Isosporiasis]', ''),
(349, 'Japanese Encephalitis (JE)', ''),
(350, 'Japanese Encephalitis (JE) Vaccination', ''),
(351, 'Jaundice', ''),
(352, 'JE (Japanese Encephalitis)', ''),
(353, 'JE (Japanese Encephalitis) Vaccination', ''),
(354, 'K. pneumoniae (Klebsiella pneumoniae)', ''),
(355, 'Kala-Azar', ''),
(356, 'Kawasaki Disease (KD)', ''),
(357, 'Kawasaki Syndrome', ''),
(358, 'KD (Kawasaki Disease)', ''),
(359, 'Keratitis, Acanthamoeba', ''),
(360, 'Keratitis, Fungal', ''),
(361, 'Kernicterus', ''),
(362, 'KFD (Kyasanur Forest disease)', ''),
(363, 'Kidney Disease (CKD)', ''),
(364, 'Klebsiella pneumoniae (K. pneumoniae)', ''),
(365, 'Kyasanur Forest disease (KFD)', ''),
(366, 'La Crosse Encephalitis (LAC)', ''),
(367, 'La Crosse Encephalitis virus (LACV)', ''),
(368, 'LAC (La Crosse Encephalitis)', ''),
(369, 'LACV (La Crosse Encephalitis virus)', ''),
(370, 'Lassa Fever', ''),
(371, 'Latex Allergies', ''),
(372, 'LCM (Lymphocytic Choriomeningitis)', ''),
(373, 'Lead Poisoning', ''),
(374, 'Legionellosis', ''),
(375, 'Legionnaires'' Disease [Legionellosis]', ''),
(376, 'Leishmania Infection [Leishmaniasis]', ''),
(377, 'Leishmaniasis', ''),
(378, 'Leprosy', ''),
(379, 'Leptospira Infection [Leptospirosis]', ''),
(380, 'Leptospirosis', ''),
(381, 'Lice', ''),
(382, 'Listeria Infection [Listeriosis]', ''),
(383, 'Listeriosis', ''),
(384, 'Liver Disease and Hepatitis', ''),
(385, 'Loa loa Infection', ''),
(386, 'Lockjaw', ''),
(387, 'Lockjaw Vaccination', ''),
(388, 'Loiasis [Loa loa Infection]', ''),
(389, 'Lou Gehrig''s Disease', ''),
(390, 'LUHF (Lujo Hemorrhagic Fever)', ''),
(391, 'Lujo Hemorrhagic Fever (LUHF)', ''),
(392, 'Lung Cancer', ''),
(393, 'Lupus (SLE) [Systemic lupus erythematosus]', ''),
(394, 'Lyme Disease [Borrelia burgdorferi Infection]', ''),
(395, 'Lymphatic Filariasis', ''),
(396, 'Lymphedema', ''),
(397, 'Lymphocytic Choriomeningitis (LCM)', ''),
(398, 'MAC (Mycobacterium avium Complex)', ''),
(399, 'Malaria', ''),
(400, 'Marburg Hemorrhagic Fever', ''),
(401, 'Marine Toxins', ''),
(402, 'MD (Muscular Dystrophy)', ''),
(403, 'MDR TB (Multidrug-Resistant TB)', ''),
(404, 'Measles', ''),
(405, 'Measles Vaccination', ''),
(406, 'Melioidosis [Burkholderia pseudomallei Infection]', ''),
(407, 'Men''s Health', ''),
(408, 'Meningitis', ''),
(409, 'Meningococcal Disease', ''),
(410, 'Meningococcal Vaccination', ''),
(411, 'Mental Health', ''),
(412, 'Mental Health and Genetics', ''),
(413, 'Mental Retardation', ''),
(414, 'MERS-CoV (Middle East Respiratory Syndrome Coronavirus)', ''),
(415, 'Methicillin Resistant Staphylococcus aureus', ''),
(416, 'Microcephaly', ''),
(417, 'Micronutrient Malnutrition', ''),
(418, 'Microsporidia Infection', ''),
(419, 'Middle East Respiratory Syndrome Coronavirus (MERS-CoV)', ''),
(420, 'MMR Vaccination', ''),
(421, 'Molluscum Contagiosum', ''),
(422, 'Motor Vehicle Injuries', ''),
(423, 'MRSA [Methicillin Resistant Staphylococcus aureus]', ''),
(424, 'Mucormycosis', ''),
(425, 'Mucus', ''),
(426, 'Multiple organ dysfunction syndrome', ''),
(427, 'Mumps', ''),
(428, 'Mumps Vaccination', ''),
(429, 'Muscular Dystrophy (MD)', ''),
(430, 'Musculoskeletal Disorders', ''),
(431, 'Mycobacterium abscessus Infection', ''),
(432, 'Mycobacterium avium Complex (MAC)', ''),
(433, 'Mycobacterium tuberculosis Infection', ''),
(434, 'Mycoplasma pneumoniae Infection', ''),
(435, 'Mycotic diseases', ''),
(436, 'Myelomeningocele', ''),
(437, 'Myiasis', ''),
(438, 'Naegleria Infection [Primary Amebic Meningoencephalitis (PAM)]', ''),
(439, 'Nairovirus Infection', ''),
(440, 'National Amyotrophic Lateral Sclerosis (ALS) Registry', ''),
(441, 'Necrotizing Fasciitis', ''),
(442, 'Neglected Tropical Diseases (NTD)', ''),
(443, 'Neisseria gonorrhoeae Infection', ''),
(444, 'Pneumocystis jirovecii pneumonia (previously Pneumocystis carinii)', ''),
(445, 'Neurocysticercosis', ''),
(446, 'Newborn Hearing', ''),
(447, 'Newborn Jaundice [Kernicterus]', ''),
(448, 'Nocardia asteroides Infection', ''),
(449, 'Nocardiosis [Nocardia asteroides Infection]', ''),
(450, 'Non-Polio Enterovirus Infections', ''),
(451, 'Nonpathogenic (Harmless) Intestinal Protozoa', ''),
(452, 'Norovirus Infection', ''),
(453, 'Norwalk-like Viruses (NLV)', ''),
(454, 'NTD (Neglected Tropical Diseases)', ''),
(455, 'Nutrition', ''),
(456, 'OA (Osteoarthritis)', ''),
(457, 'Obesity and Genetics', ''),
(458, 'Obesity and Overweight', ''),
(459, 'Obesity and Overweight, Childhood ', ''),
(460, 'Occupational Cancers', ''),
(461, 'Occupational Skin Conditions', ''),
(462, 'Occupational Stress', ''),
(463, 'OHF (Omsk hemorrhagic fever)', ''),
(464, 'Omsk hemorrhagic fever (OHF)', ''),
(465, 'Onchocerciasis', ''),
(466, 'Opisthorchis Infection', ''),
(467, 'Oral Cancer', ''),
(468, 'Orf Virus Infection', ''),
(469, 'Oropharyngeal Candidiasis', ''),
(470, 'Oroya fever', ''),
(471, 'Osteoarthritis (OA)', ''),
(472, 'Otitis Media', ''),
(473, 'Outbreaks', ''),
(474, 'Ovarian and Breast Cancer', ''),
(475, 'PAD (Peripheral Arterial Disease)', ''),
(476, 'Pandemic Flu', ''),
(477, 'Paragonimiasis', ''),
(478, 'Paragonimus Infection [Paragonimiasis]', ''),
(479, 'Parainfluenza', ''),
(480, 'Parasitic Diseases', ''),
(481, 'Parvovirus B19 Infection', ''),
(482, 'PCP (Pneumocystis pneumonia)', ''),
(483, 'PCV (Pneumococcal Conjugate Vaccine)', ''),
(484, 'PE (Pulmonary Embolism)', ''),
(485, 'Pedestrian Injury', ''),
(486, 'Pediculus humanus capitis', ''),
(487, 'Pediculus humanus corporis', ''),
(488, 'Pelvic Inflammatory Disease (PID)', ''),
(489, 'Peripheral Arterial Disease (PAD)', ''),
(490, 'Peripheral Arterial Insufficiency ', ''),
(491, 'Peripheral Arterial Occlusive Disease', ''),
(492, 'Peripheral Vascular Disease', ''),
(493, 'Pertussis (Whooping Cough)', ''),
(494, 'Pertussis (Whooping Cough) Vaccination', ''),
(495, 'Phthiriasis', ''),
(496, 'PID (Pelvic Inflammatory Disease)', ''),
(497, 'Pigs, Influenza in', ''),
(498, 'Pink Eye [Conjunctivitis]', ''),
(499, 'Pinworm Infection [Enterobius vermicularis Infection]', ''),
(500, 'Plague [Yersinia pestis Infection]', ''),
(501, 'Pneumococcal Conjugate Vaccine (PCV)', ''),
(502, 'Pneumococcal Disease', ''),
(503, 'Pneumococcal Polysaccharide Vaccine (PPV)', ''),
(504, 'Pneumoconioses, Coal Workers', ''),
(505, 'Pneumocystis carinii Pneumonia (PCP) Infection', ''),
(506, 'Pneumocystis pneumonia (PCP) [Pneumocystis jirovecii pneumonia (previously Pneumocystis carinii) ]', ''),
(507, 'Pneumonia', ''),
(508, 'Polio Infection [Poliomyelitis Infection]', ''),
(509, 'Polio Vaccination [Poliomyelitis Vaccination]', ''),
(510, 'Poliomyelitis Infection', ''),
(511, 'Poliomyelitis Vaccination', ''),
(512, 'Pontiac Fever', ''),
(513, 'Powassan (POW) virus', ''),
(514, 'Poxvirus Infections', ''),
(515, 'PPV (Pneumococcal Polysaccharide Vaccine)', ''),
(516, 'Pregnancy', ''),
(517, 'Primary Amebic Meningoencephalitis (PAM)', ''),
(518, 'Prion Diseases (TSEs) [Transmissible spongiform encephalopathies]', ''),
(519, 'Prostate Cancer', ''),
(520, 'Pseudomonas dermatitis Infection', ''),
(521, 'Psittacosis', ''),
(522, 'Psoriasis', ''),
(523, 'Pubic Lice [Phthiriasis]', ''),
(524, 'Pulmonary Embolism (PE)', ''),
(525, 'Pulmonary Hypertension', ''),
(526, 'Q Fever [Coxiella burnetii Infection]', ''),
(527, 'RA (Rheumatoid Arthritis)', ''),
(528, 'Rabies', ''),
(529, 'Rabies Vaccination', ''),
(530, 'Raccoon Roundworm Infection [Baylisascaris Infection]', ''),
(531, 'Rat-Bite Fever (RBF) [Streptobacillus moniliformis Infection]', ''),
(532, 'RBF (Rat-Bite Fever)', ''),
(533, 'Recalled Vaccines', ''),
(534, 'Recreational Water Illness (RWI)', ''),
(535, 'Reptiles, Infections from', ''),
(536, 'Respiratory Syncytial Virus Infection (RSV)', ''),
(537, 'Rheumatoid Arthritis (RA)', ''),
(538, 'Rickettsia rickettsii Infection', ''),
(539, 'Rickettsia, Spotted Fever Group', ''),
(540, 'Rickettsial Diseases', ''),
(541, 'Rift Valley Fever (RVF)', ''),
(542, 'Ringworm [Dermatophyte Infection]', ''),
(543, 'RMSF (Rocky Mountain Spotted Fever)', ''),
(544, 'Rodent Control', ''),
(545, 'Rotavirus Infection', ''),
(546, 'Rotavirus Vaccination', ''),
(547, 'RSV (Respiratory Syncytial Virus Infection)', ''),
(548, 'Rubella (German Measles) Vaccination', ''),
(549, 'Rubeola', ''),
(550, 'Runny Nose', ''),
(551, 'RVF (Rift Valley Fever)', ''),
(552, 'RWI (Recreational Water Illness)', ''),
(553, 'Salmonella typhi Infection', ''),
(554, 'Salmonella Infection [Salmonellosis]', ''),
(555, 'Salmonella Infection from Animals', ''),
(556, 'Salmonellosis', ''),
(557, 'Sappinia diploidea and Sappinia pedata', ''),
(558, 'Sappinia Infection [Sappinia diploidea and Sappinia pedata]', ''),
(559, 'SARS [Severe Acute Respiratory Syndrome]', ''),
(560, 'Scabies', ''),
(561, 'Scarlet Fever', ''),
(562, 'Schistosoma Infection', ''),
(563, 'Schistosomiasis [Schistosoma Infection]', ''),
(564, 'Seasonal Flu', ''),
(565, 'Sepsis [Septicemia]', ''),
(566, 'Septic shock', ''),
(567, 'Septicemia', ''),
(568, 'Severe Acute Respiratory Syndrome ', ''),
(569, 'Sexually Transmitted Disease', ''),
(570, 'Syphilis [Treponema pallidum Infection]', ''),
(571, 'SFGR (Spotted Fever Group Rickettsia)', ''),
(572, 'Shigella Infection [Shigellosis]', ''),
(573, 'Shigellosis', ''),
(574, 'Shingles [Varicella Zoster Virus (VZV)]', ''),
(575, 'Shingles Vaccination', ''),
(576, 'Sickle Cell Disease', ''),
(577, 'SIDS (Sudden Infant Death Syndrome)', ''),
(578, 'Sinus Infection [Sinusitus]', ''),
(579, 'Skin Cancer', ''),
(580, 'Skin Cancer and Genetics', ''),
(581, 'Skin Conditions, Occupational', ''),
(582, 'SLE (Lupus)', ''),
(583, 'Sleep and Sleep Disorders', ''),
(584, 'Sleeping Sickness [African Trypanosomiasis]', ''),
(585, 'Smallpox [Variola Major and Variola Minor]', ''),
(586, 'Smallpox Vaccination', ''),
(587, 'Smoking and Tobacco Use', ''),
(588, 'Soil Transmitted Helminths', ''),
(589, 'Sore Mouth Infection [Orf Virus Infection]', ''),
(590, 'Sore Throat', ''),
(591, 'Southern Tick-Associated Rash Illness (STARI)', ''),
(592, 'Spina Bifida [Myelomeningocele]', ''),
(593, 'Spirillum minus Infection', ''),
(594, 'Sporothrix schenckii infection', ''),
(595, 'Sporotrichosis [Sporothrix schenckii infection]', ''),
(596, 'Spotted Fever Group Rickettsia (SFGR)', ''),
(597, 'Staph', ''),
(598, 'Staphylococcus aureus Infection', ''),
(599, 'STARI (Southern Tick-Associated Rash Illness)', ''),
(600, 'Strep Throat', ''),
(601, 'Streptobacillus moniliformis Infection', ''),
(602, 'Streptococcus pneumoniae Infection', ''),
(603, 'Stress, Occupational', ''),
(604, 'Stroke', ''),
(605, 'Stroke and Genetics', ''),
(606, 'Strongyloidiasis', ''),
(607, 'Swimmer''s Itch [Cercarial Dermatitis]', ''),
(608, 'Swimming-related Illness', ''),
(609, 'Swine Influenza', ''),
(610, 'Symptom Relief for Upper Respiratory Infections', ''),
(611, 'Syphilis [Treponema pallidum Infection]', ''),
(612, 'Systemic lupus erythematosus', ''),
(613, 'Taenia Infection', ''),
(614, 'TB (Tuberculosis)', ''),
(615, 'TB (Tuberculosis) Vaccination', ''),
(616, 'TB and HIV Coinfection', ''),
(617, 'TBI (Traumatic Brain Injury)', ''),
(618, 'Testicular Cancer', ''),
(619, 'Tetanus (Lockjaw) Infection', ''),
(620, 'Tetanus (Lockjaw) Vaccination', ''),
(621, 'Tetanus Disease [Clostridium tetani Infection]', ''),
(622, 'Thalassemia', ''),
(623, 'Thoracic Aortic Aneurysm', ''),
(624, 'Thrombophilia', ''),
(625, 'Thrombosis', ''),
(626, 'Thrush [Oropharyngeal Candidiasis]', ''),
(627, 'Tickborne Diseases', ''),
(628, 'Ticks', ''),
(629, 'Tularemia [Francisella tularensis Infection]', ''),
(630, 'Tinea', ''),
(631, 'Tourette Syndrome (TS)', ''),
(632, 'Toxocara Infection', ''),
(633, 'Toxocariasis [Toxocara Infection]', ''),
(634, 'Toxoplasma Infection', ''),
(635, 'Toxoplasmosis [Toxoplasma Infection]', ''),
(636, 'Trachoma Infection', ''),
(637, 'Transmissible spongiform encephalopathies', ''),
(638, 'Traumatic Occupational Injuries', ''),
(639, 'Trench fever [Bartonella quintana Infection]', ''),
(640, 'Treponema pallidum Infection', ''),
(641, 'Trichinellosis (Trichinosis)', ''),
(642, 'Trichomonas Infection', ''),
(643, 'Trichomoniasis [Trichomonas Infection]', ''),
(644, 'Trisomy 21', ''),
(645, 'Trypanosoma cruzi Infection', ''),
(646, 'Trypanosomiasis, African', ''),
(647, 'TS (Tourette Syndrome )', ''),
(648, 'TSEs (Prion Diseases)', ''),
(649, 'Tularemia [Francisella tularensis Infection]', ''),
(650, 'Typhoid Fever [Salmonella typhi Infection]', ''),
(651, 'Typhoid Fever Vaccination', ''),
(652, 'Typhus Fevers', ''),
(653, 'Ulcerative Colitis', ''),
(654, 'Undulant Fever', ''),
(655, 'Unexplained Respiratory Disease Outbreaks (URDO)', ''),
(656, 'URDO (Unexplained Respiratory Disease Outbreaks)', ''),
(657, 'Uterine Cancer', ''),
(658, 'Vaginal and Vulvar Cancers', ''),
(659, 'Vaginal Candidiasis', ''),
(660, 'Valley Fever [Coccidioidomycosis]', ''),
(661, 'Vancomycin-Intermediate/Resistant Staphylococcus aureus Infections [VISA/VRSA]', ''),
(662, 'Vancomycin-resistant Enterococci Infection (VRE)', ''),
(663, 'Variant Creutzfeldt-Jakob Disease (vCJD)', ''),
(664, 'Variant Viruses', ''),
(665, 'Varicella Disease', ''),
(666, 'Varicella Vaccination', ''),
(667, 'Varicella Zoster Virus (VZV)', ''),
(668, 'Varicella-Zoster Virus Infection', ''),
(669, 'Variola Major and Variola Minor', ''),
(670, 'vCJD (Variant Creutzfeldt-Jakob Disease)', ''),
(671, 'verruga peruana', ''),
(672, 'VHF (Viral Hemorrhagic Fevers)', ''),
(673, 'Vibrio cholerae Infection', ''),
(674, 'Vibrio Illness [Vibriosis]', ''),
(675, 'Vibriosis', ''),
(676, 'Viral Hemorrhagic Fevers (VHF)', ''),
(677, 'Viral Hepatitis', ''),
(678, 'Viral Meningitis [Aseptic Meningitis]', ''),
(679, 'VISA/VRSA', ''),
(680, 'Vision Impairment', ''),
(681, 'VRE (Vancomycin-resistant Enterococci Infection)', ''),
(682, 'Vulvovaginal Candidiasis', ''),
(683, 'VVC (Genital Candidiasis)', ''),
(684, 'VZV (Varicella Zoster Virus)', ''),
(685, 'West Nile Virus Infection (WNV Infection)', ''),
(686, 'Whipworm Infection [Trichuriasis]', ''),
(687, 'Whitmore''s Disease', ''),
(688, 'Whooping Cough', ''),
(689, 'WNV Infection (West Nile Virus Infection)', ''),
(690, 'Women''s Bleeding Disorders', ''),
(691, 'Women''s Health', ''),
(692, 'XDR TB (Extensively Drug-Resistant TB)', ''),
(693, 'Xenotropic Murine Leukemia Virus', ''),
(694, 'XMRV Infection', ''),
(695, 'Yeast Infection', ''),
(696, 'Yellow Fever', ''),
(697, 'Yellow Fever Vaccination', ''),
(698, 'Yersinia enterocolitica Infection', ''),
(699, 'Yersinia pestis Infection', ''),
(700, 'Yersiniosis [Yersinia enterocolitica Infection]', ''),
(701, 'Zika Virus Infection', ''),
(702, 'Zoonotic Hookworm', ''),
(703, 'Zoster', ''),
(704, 'Zygomycosis', '');
...
--
-- Table structure for table `pdhp_doctor`
--

CREATE TABLE IF NOT EXISTS `pdhp_doctor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_doctor`
--

INSERT INTO `pdhp_doctor` (`id`, `username`, `password`, `email`, `phone`, `first_name`, `last_name`, `dob`, `gender`, `cid`, `sid`, `s_s_n`, `i_n`, `reg_no`, `d_id`) VALUES
(1, 'Nabil', '2311', 'nabil_n@hotmail.com', 'kljhgf', 'Nabil', 'Nasifur Rahman', '1991-12-30', 0, 4, 0, 981981987, 918719872, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `pdhp_environmentalist`
--

CREATE TABLE IF NOT EXISTS `pdhp_environmentalist` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(30) NOT NULL,
  `password` varchar(30) NOT NULL,
  `email` varchar(30) NOT NULL,
  ...
  `cid` int(10) NOT NULL,
  `sid` int(10) NOT NULL,
  `s_s_n` varchar(9) NOT NULL,
  `i_n` varchar(9) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `pdhp_environmentalist`
--
...
--
-- Table structure for table `pdhp_hospital`
--

CREATE TABLE IF NOT EXISTS `pdhp_hospital` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_hospital`
--

INSERT INTO `pdhp_hospital` (`id`, `name`, `username`, `password`, `email`, `website`, `phone`, `address`, `reg_num`, `cid`, `sid`) VALUES
(1, 'RedCre', '1234', '0', 'joys@gmail.com', '98239871987', '0', '293849887', '0', 0, 0),
(2, 'sadkjhkj vhj jjh', 'sdhfk', '123456', 'jamshedhossan9@gmail.com', 'www.olmisbd.com', '01627045062', 'Chandgaon R/A', 'http://ww', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `pdhp_hospital_dept`
--

CREATE TABLE IF NOT EXISTS `pdhp_hospital_dept` (
  `id` int(3) NOT NULL AUTO_INCREMENT,
  `h_id` int(11) NOT NULL,
  `d_id` int(3) NOT NULL,
  `num_seat` int(11) NOT NULL,
  `num_opd` int(11) NOT NULL,
  `num_doc` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `pdhp_hospital_dept`
--
...
--
-- Table structure for table `pdhp_h_d_s`
--

CREATE TABLE IF NOT EXISTS `pdhp_h_d_s` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `h_id` int(11) NOT NULL,
  `doc_avail` int(11) NOT NULL,
  `seats_avail` int(11) NOT NULL,
  `opd_visits` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `pdhp_h_d_s`
--
...
--
-- Table structure for table `pdhp_patient`
--

CREATE TABLE IF NOT EXISTS `pdhp_patient` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(30) NOT NULL,
  `password` varchar(30) NOT NULL,
  `email` varchar(30) NOT NULL,
...
--
-- Dumping data for table `pdhp_patient`
--
...
--
-- Table structure for table `pdhp_pat_dis`
--

CREATE TABLE IF NOT EXISTS `pdhp_pat_dis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `p_id` int(11) NOT NULL,
  `d_id` int(11) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `pdhp_pat_dis`
--
...
--
-- Table structure for table `pdhp_pat_sym`
--

CREATE TABLE IF NOT EXISTS `pdhp_pat_sym` (
  `id` int(11) NOT NULL,
  `p_id` int(11) NOT NULL,
  `s_id` int(11) NOT NULL,
...
--
-- Dumping data for table `pdhp_pat_sym`
--
...
--
-- Table structure for table `pdhp_pharmacy`
--

CREATE TABLE IF NOT EXISTS `pdhp_pharmacy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_pharmacy`
--

INSERT INTO `pdhp_pharmacy` (`id`, `name`, `username`, `email`, `password`, `address`, `reg_num`, `phone`, `cid`, `sid`) VALUES
(1, 'lsdkfj', 'sdf', 'jaysen110@gmail.com', '987987238', 'ldsfjj', '234978', '92837498', 4, 0);

-- --------------------------------------------------------

--
-- Table structure for table `pdhp_symptom`
--

CREATE TABLE IF NOT EXISTS `pdhp_symptom` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pdhp_symptom`
--

INSERT INTO `pdhp_symptom` (`id`, `symptom`, `description`) VALUES
...
(10, 'appetite loss', ''),
(11, 'weakness', ''),
(12, 'jaundice (yellowing of the skin or white area of eyes', ''),
(13, 'light or white chalk-like stools', ''),
(14, 'A lump or enlargement in either testicle', ''),
(15, 'A feeling of heaviness in the scrotum', ''),
(16, 'A dull ache in the abdomen or groin', ''),
(17, 'A sudden collection of fluid in the scrotum', ''),
(18, 'Enlargement or tenderness of the breasts', ''),
(19, 'Pain or discomfort in a testicle or the scrotum', ''),
(20, 'skin irritation or dimpling', ''),
(21, 'breast pain', ''),
(22, 'nipple pain or the nipple turning inward', ''),
(23, 'redness, scaliness, or thickening of the nipple or breast skin', ''),
(24, 'a nipple discharge other than breast milk', ''),
(25, 'a lump in the underarm area', ''),
(26, 'A lump or enlargement in either testicle', ''),
(27, 'A feeling of heaviness in the scrotum', ''),
(28, 'A dull ache in the abdomen or groin', ''),
(29, 'A sudden collection of fluid in the scrotum', ''),
(30, 'Pain or discomfort in a testicle or the scrotum', ''),
(31, 'Enlargement or tenderness of the breasts', ''),
(32, 'Back pain', ''),
(33, 'swelling of all or part of the breast', ''),
(34, 'skin irritation or dimpling', ''),
(35, 'jaundice (yellow skin)', ''),
(36, 'weight loss', ''),
(37, 'dark urine', ''),
(38, 'light stool color', ''),
(39, 'itching', ''),
(40, 'abdominal pain', ''),
(41, 'vomiting', ''),
(42, 'abdominal pain', ''),
(43, 'Enlargement or tenderness of the breasts', ''),
(44, 'enlarged lymph nodes in the neck', ''),
(45, 'Swelling of lymph nodes or glands in the neck, under the arms, or in the groin', ''),
(46, 'a discomfort or fullness in the upper left part of the abdomen', ''),
(47, 'Fever', ''),
...
(51, 'Fatigue', ''),
(52, 'Pica', ''),
(53, 'painless swollen lymphs at neck', ''),
(54, 'painless swollen lymphs at groin', ''),
(55, 'Fever', ''),
(56, 'Night sweats', ''),
(57, 'Pain in the front of the neck, sometimes going up to the ears', ''),
(58, 'Hoarseness or other voice changes that do not go away', ''),
(59, 'Trouble swallowing', ''),
(60, 'Infantile Tay–Sachs', ''),
(61, 'Juvenile Tay–Sachs', ''),
(62, 'Adult/Late-Onset Tay–Sachs', ''),
(63, 'flat facial features', ''),
(64, 'small head and ears', ''),
(65, 'flat facial features', ''),
(66, 'short neck', ''),
(67, 'bulging tongue', ''),
(68, 'eyes that slant upward', ''),
(69, 'oddly shaped ears', ''),
(70, 'poor muscle tone', ''),
(71, 'Sleep Dysfunction', ''),
(72, 'Seizure Disorders', ''),
(73, 'Sensory Processing Problems', ''),
(74, 'Persistent Diarrhea', ''),
(75, 'Rectal bleeding', ''),
(76, 'Urgent need to move bowels', ''),
(77, 'Abdominal cramps and pain', ''),
(78, 'Sensation of incomplete evacuation', ''),
(79, 'Constipation (can lead to bowel obstruction)', ''),
(80, 'increased abdominal sounds', ''),
(81, 'bloody stools', ''),
(82, 'rectal pain', ''),
(83, 'malnutrition', ''),
(84, 'Discomfort in the arms', ''),
(85, 'Discomfort in back', ''),
(86, 'Discomfort in neck', ''),
(87, 'Discomfort in jaw', ''),
(88, 'Discomfort in upper part of stomach', ''),
(89, 'Fainting', ''),
(90, 'Light-headedness', ''),
(91, 'vomiting', ''),
(92, 'cold sweat', ''),
(93, 'Sleep problems', ''),
(94, 'a persistent headache', ''),
(95, 'blurred or double vision', ''),
(96, 'nosebleeds', ''),
(97, 'shortness of breath', ''),
(98, 'general fatigue', ''),
(99, 'weakness', ''),
(100, 'pale skin', ''),
(101, 'shortness of breath', ''),
(102, 'dizziness', ''),
(103, 'strange cravings to eat items that arent food, such as dirt, ice, or clay', ''),
(104, 'a tingling or crawling feeling in the legs', ''),
(105, 'tongue swelling or soreness', ''),
(106, 'Cold fingers or toes', ''),
(107, 'Color changes in your skin in response to cold or stress', ''),
(108, 'Numb, prickly feeling or stinging pain upon warming or stress relief', ''),
(109, 'irregular heartbeat', ''),
(110, 'a cough that develops from congested lungs', ''),
(111, 'wheezing', ''),
(112, 'shortness of breath, which may indicate pulmonary edema', ''),
(113, 'Breathlessness with exertion or even at rest', ''),
(114, 'Swelling of the legs, ankles and feet', ''),
(115, 'Bloating of the abdomen due to fluid buildup', ''),
(116, 'Cough while lying down', ''),
(117, 'Irregular heartbeats that feel rapid, pounding or fluttering', ''),
(118, 'Chest pain', ''),
(119, 'Rapid or irregular heart rate', ''),
(120, 'Pale skin', ''),
(121, 'Frequent or prolonged infections', ''),
(122, 'Unexplained or easy bruising', ''),
(123, 'Nosebleeds and bleeding gums', ''),
(124, 'Prolonged bleeding from cuts', ''),
(125, 'Joint pain', ''),
(126, 'Joint tenderness', ''),
(127, 'Joint swelling', ''),
(128, 'Joint redness', ''),
(129, 'Joint warmth', ''),
(130, 'Joint stiffness', ''),
(131, 'Loss of joint range of motion', ''),
(132, 'Headache', ''),
(133, 'Swelling (edema) in feet', ''),
(134, 'Swelling legs', ''),
(135, 'Sweliing hands', ''),
(136, 'Swelling around eyes', ''),
(137, 'swollen lymph glands', ''),
(138, 'unusual lesions on the tongue', ''),
(139, 'Skin rashes and bumps', ''),
(140, 'chronic fatigue', ''),
(141, 'blurred or distorted vision', ''),
(142, 'rash on the arms, legs, face, or belly', ''),
(143, 'sore throat', ''),
(144, 'swollen lymph glands', ''),
(145, 'mouth or genital ulcers', ''),
(146, 'bad headaches', ''),
(147, 'muscle aches and joint pain', ''),
(148, 'Abnormally dark or light skin', ''),
(149, 'Bone pain', ''),
(150, 'Drowsiness or problems concentrating or thinking', ''),
(151, 'Numbness or swelling in the hands and feet', ''),
(152, 'Muscle twitching or cramps', ''),
(153, 'Breath odor', ''),
(154, 'Easy bruising, or blood in the stool', ''),
(155, 'Excessive thirst', ''),
(156, 'nausea or vomiting', ''),
(157, 'pain in your stomach', ''),
(158, 'joint or muscle pain', ''),
(159, 'abnormalities in urine or bowel movements', ''),
(160, 'a yellowing in your eyes or skin', ''),
(161, 'Pain in your pelvis or between the vagina and anus in women or between the scrotum and anus in men (', ''),
(162, 'Chronic pelvic pain', ''),
(163, 'A persistent, urgent need to urinate', ''),
(164, 'Frequent urination', ''),
(165, 'Pain or discomfort while the bladder fills and relief after urinating', ''),
(166, 'Pain during sexual intercourse', ''),
(167, 'Upper abdominal pain', ''),
(168, 'Abdominal pain that radiates to your back', ''),
(169, 'Abdominal pain that feels worse after eating', ''),
(170, 'Tenderness when touching the abdomen', ''),
(171, 'Abdominal pain', ''),
(172, 'Bloating or swelling in the abdomen', ''),
(173, 'Feeling full', ''),
(174, 'Bleeding into a cyst', ''),
(175, 'Infection of a cyst', ''),
(176, 'Bile duct obstruction and jaundice', ''),
(177, 'Shortness of breath, particularly during exercise', ''),
(178, 'Dry, hacking cough', ''),
(179, 'Fast, shallow breathing', ''),
(180, 'Gradual unintended weight loss', ''),
(181, 'Tiredness', ''),
(182, 'Aching joints and muscles', ''),
(183, 'Clubbing (widening and rounding) of the tips of the fingers or toes', ''),
(184, 'Coughing, especially at night, during exercise or when laughing', ''),
(185, 'Difficulty breathing', ''),
(186, 'Chest tightness', ''),
(187, 'Wheezing (a whistling or squeaky sound in your chest when breathing, especially when exhaling', ''),
(188, 'COPD can cause breathlessness (also called shortness of breath or dyspnea)', ''),
(189, 'cough', ''),
(190, 'production of mucus/sputum/phlegm', ''),
(191, 'tiredness(also called fatigue)', ''),
(192, 'Symptoms such as breathlessness', ''),
(193, 'Exercise intolerance', ''),
(194, 'Repeated lung infections', ''),
(195, 'Inflamed nasal passages or a stuffy nose', ''),
(196, 'Foul-smelling, greasy stools', ''),
(197, 'Poor weight gain and growth', ''),
(198, 'Intestinal blockage, particularly in newborns (meconium ileus)', ''),
(199, 'Severe constipation', ''),
(200, 'Shortness of breath (dyspnea), initially while exercising and eventually while at rest', ''),
(201, 'Dizziness or fainting spells (syncope)', ''),
(202, 'Chest pressure or pain', ''),
(203, 'Swelling (edema) in your ankles, legs and eventually in your abdomen (ascites)', ''),
(204, 'asthma', ''),
(205, 'emphysema', ''),
(206, 'bronchiectasis', ''),
(207, 'Penile erection occurs but it is not maintained for the length of sexual activity', ''),
(208, 'Penile erection that is not firm enough to penetrate the vagina', ''),
(209, 'Inability to obtain a penile erection', ''),
(210, 'Changes in hair growth', ''),
(211, 'Changes in sexual desire', ''),
(212, 'Pain, lump, or swelling in the testicles', ''),
(213, 'Problems with erections and ejaculation', ''),
(214, 'Small, firm testicles', ''),
(215, 'Frequent or urgent need to urinate', ''),
(216, 'Increased frequency of urination at night (nocturia)', ''),
(217, 'Difficulty starting urination', ''),
(218, 'Weak urine stream or a stream that stops and starts', ''),
(219, 'Dribbling at the end of urination', ''),
(220, 'Straining while urinating', ''),
(221, 'Inability to completely empty the bladder', ''),
(222, 'slowness of movement, tremor, or rigidity (stiffness)', ''),
(223, 'clumsiness or incoordination', ''),
(224, 'impaired speech, a croaky, quivering voice', ''),
(225, 'fainting or lightheadedness due to orthostatic hypotension', ''),
(226, 'bladder control problems, such as a sudden urge to urinate or difficulty emptying the bladder', ''),
(227, 'Loss or blurring of vision in one or both eyes', ''),
(228, 'Loss of color vision', ''),
(229, 'Stiffness, weakness and spasticity in your legs Tripping, difficulty with balance', ''),
(230, 'clumsiness as the leg muscles weaken', ''),
(231, 'sudden loss of balance when walking, that usually results in repeatedfalls, often backwards', ''),
(232, 'muscle stiffness, particularly in the neck', ''),
(233, 'extreme tiredness', ''),
(234, 'changes in personality, such as irritability, apathy (lack of interest) and mood swings', ''),
(235, 'changes in behaviour, such as recklessness and poor judgement', ''),
(236, 'a dislike of bright lights (photophobia)', ''),
(237, 'difficulty controlling the eye muscles, particularly problems with looking up and down', ''),
(238, 'blurred or double vision', ''),
(239, 'a clumsy or useless hand', ''),
(240, 'muscle stiffness', ''),
(241, 'shaking (tremors) and spasms (dystonia)', ''),
(242, 'loss of feeling', ''),
(243, 'feeling like the limb doesnt belong to you (an alien limb)', ''),
(244, 'problems recalling words, reading and using correct language (aphasia)', ''),
(245, 'short-term memory loss', ''),
(246, 'problems carrying out tasks that require planning or thinking ahead', ''),
(247, 'problems coping with sudden and unexpected situations', ''),
(248, 'difficulty with numbers and counting', ''),
(249, 'difficulty seeing things, or knowing where they are located (such as furniture)', ''),
(250, 'Sudden numbness or weakness in the face, arm, or leg, especially on one side of the body', ''),
(251, 'Sudden confusion, trouble speaking, or difficulty understanding speech', ''),
(252, 'Sudden trouble seeing in one or both eyes', ''),
(253, 'Sudden trouble walking, dizziness, loss of balance, or lack of coordination', ''),
(254, 'feeling dizzy or faint', ''),
(255, 'increased sensitivity to light and sound', ''),
(256, 'nausea', ''),
(257, 'pain on one side of the head', ''),
(258, 'pulsing and/or throbbing pain', ''),
(259, 'vomiting', ''),
(260, 'Plaques of red, inflamed skin, often covered with loose, silver-colored scales', ''),
(261, 'Disorders of the fingernails and toenails, including discoloration and pitting of the nails', ''),
(262, 'Scaly plaques on the scalp', ''),
(263, 'Visible broken blood vessels (spider veins)', ''),
(264, 'Swollen skin', ''),
(265, 'Skin may be very sensitive', ''),
(266, 'Skin may sting and burn', ''),
(267, 'Dry skin, roughness or scaling', ''),
(268, 'Have a tendency to flush or blush more easily than other people', ''),
(269, 'dermatitis', ''),
(270, 'Abdominal cramps or back pain during menstruation', ''),
(271, 'Very painful menstrual cramps', ''),
(272, 'Painful bowel movements', ''),
(273, 'Painful urination, especially during menstruation', ''),
(274, 'Abnormal or heavy bleeding during periods', ''),
(275, 'Painful sex', ''),
(276, 'Difficulty becoming pregnant', ''),
(277, 'Infertility (not able to get pregnant) because of not ovulating', ''),
(278, 'Infrequent, absent, and/or irregular menstrual periods', ''),
(279, 'Hirsutism (HER-suh-tiz-um)', ''),
(280, 'increased hair growth on the face', ''),
(281, 'increased hair growth chest', ''),
(282, 'increased hair growth stomach', ''),
(283, 'increased hair growth on the back', ''),
(284, 'increased hair growth thumbs or toes', ''),
(285, 'Cysts on the ovaries', ''),
(286, 'Acne, oily skin, or dandruff', ''),
(287, 'Depressed mood or severe mood swings', ''),
(288, 'Excessive crying', ''),
(289, 'Difficulty bonding with your baby', ''),
(290, 'Withdrawing from family and friends', ''),
(291, 'Loss of appetite or eating much more than usual', ''),
(292, 'Inability to sleep (insomnia) or sleeping too much', ''),
(293, 'Overwhelming fatigue or loss of energy', ''),
(294, 'Vaginal dryness', ''),
(295, 'Mood swing', ''),
(296, 'Hot flashes', ''),
(297, 'UTIs', ''),
(298, 'Decreased sex drive', ''),
(299, 'Bodily aches', ''),
(300, 'Running Nose', ''),
(301, 'Wheezing', ''),
(302, 'Sneezing', ''),
(303, 'Nasal Obstruction', '');

-- --------------------------------------------------------

--
-- Table structure for table `pharmacy_disease_count`
--

CREATE TABLE IF NOT EXISTS `pharmacy_disease_count` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `p_id` int(11) NOT NULL,
  `d_id` int(11) NOT NULL,
  `date_time` datetime NOT NULL,
  `num_cus` int(11) NOT NULL,
  `num_pre_cus` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Dumping data for table `pharmacy_disease_count`
--
...
--
-- Constraints for table `pdhp_city`
--
ALTER TABLE `pdhp_city`
  ADD CONSTRAINT `subregion_region_id` FOREIGN KEY (`region_id`) REFERENCES `pdhp_country` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `pdhp_pat_sym`
--
ALTER TABLE `pdhp_pat_sym`
  ADD CONSTRAINT `patient_id` FOREIGN KEY (`p_id`) REFERENCES `pdhp_patient` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `symptom_id` FOREIGN KEY (`s_id`) REFERENCES `pdhp_symptom` (`id`);
